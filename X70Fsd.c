/*++
    ...
    本人程序员生涯中有快5年的windows驱动开发，这个程序作为我5年windows驱动开发工作的结束，
    从此本人将不再写windows驱动，如果您有什么问题可以给我email：196245957@qq.com
    ...
    --*/
{
    ...
    PT_DBG_PRINT(PTDBG_TRACE_ROUTINES, ("PassThrough!DriverEntry: Entered\n"));
    ...
    --*/
{
    ...
    PT_DBG_PRINT(PTDBG_TRACE_ROUTINES, ("PassThrough!PtOperationStatusCallback: Entered\n"));
