...
X70FsdSetTopLevelIrp(
    ...
    IN BOOLEAN ForceTopLevel,   // read 时候为 true, true
    ...
    )
{
    ...
    // 这里返回的是ethread-> TopLevelIrp      : Uint4B
